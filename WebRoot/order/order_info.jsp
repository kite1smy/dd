	...
	<body>
		...
		<div class="fill_message">
			...
			<table class="tab_login">
				...
				<!-- 订单开始 -->
				<s:iterator value="#session.cart.productsMap.values()" status="sta">
					<tr>
						<td valign="top">
						...
						<td valign="top">
							<s:property value="books.dangPrice"/>
						</td>
						<td valign="top">
							<s:property value="count"/>
						</td>
						<td valign="top">
							<s:property value="subCurrentMoney()"/>
						</td>
					</tr>
				</s:iterator>	
				...
				<tr>
					<td valign="top" class="w1" style="text-align: left" colspan="5">
						<b>总价￥<s:property value="#session.cart.totalMoney()"/></b>
					</td>
				</tr>
			</table>
			<br />
			...
			<div class="login_in">
				...
				<a href='<s:url action="order_showAddressList" namespace="/private"/>'><input id="btnClientRegister" class="button_1" name="submit"
